...
public class GraphOLHasKeyNode extends GraphOLNode {
	
	public GraphOLHasKeyNode() {
		
	}
	
	public GraphOLHasKeyNode(GraphOLNodeLabel nodeLabel, GraphOLNodeGeometry nodeGeometry, String type, String color, String id) {
