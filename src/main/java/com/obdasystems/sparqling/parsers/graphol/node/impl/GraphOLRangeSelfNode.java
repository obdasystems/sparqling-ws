...
public class GraphOLRangeSelfNode extends GraphOLConstructorNode implements GraphOLClassExpressionStartingNodeI {

	public GraphOLRangeSelfNode() {
		
	}
	
	public GraphOLRangeSelfNode(GraphOLNodeLabel nodeLabel, GraphOLNodeGeometry nodeGeometry, String type, String color, String id) {
