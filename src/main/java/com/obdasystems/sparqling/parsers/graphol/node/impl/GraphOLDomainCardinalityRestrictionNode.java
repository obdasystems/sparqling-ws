...
public class GraphOLDomainCardinalityRestrictionNode extends GraphOLConstructorNode implements GraphOLClassExpressionStartingNodeI {
	...
	public GraphOLDomainCardinalityRestrictionNode() {
		
	}
	
	public GraphOLDomainCardinalityRestrictionNode(GraphOLNodeLabel nodeLabel, GraphOLNodeGeometry nodeGeometry, String type, String color, String id, 
